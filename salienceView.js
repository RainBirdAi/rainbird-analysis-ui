...
function showSalience(node) {
    ...
    node.rule.conditions.forEach(function(condition, i) {
        if(condition.salience > 0) {
            ...
            if (!condition.certainty && condition.certainty !== 0)
                condition.certainty = 100;
            ...
            svg
                .append('path')
                .attr('d', 'M' + xx + ' ' + yy + ' A ' + innerRadius + ' ' + innerRadius + ' 0 0 0 ' + nextX2 + ' ' + nextY2)
            ...
            svg
                ...
                .append('path')
                .attr('d', 'M' + xx + ' ' + yy + ' A ' + innerRadius + ' ' + innerRadius + ' 0 0 0 ' + nextX + ' ' + nextY)
